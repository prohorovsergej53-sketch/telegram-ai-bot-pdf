...
0. КРИТИЧЕСКИ ВАЖНО: Если дата указана без года (например "10 марта", "с 5 по 10 июня"), ОБЯЗАТЕЛЬНО уточни: «Подскажите год?» — и только после получения года продолжай.
