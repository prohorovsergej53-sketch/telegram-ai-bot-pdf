...
def handler(event: dict, context) -> dict:
    ...
    try:
        ...
        settings = {
            ...
            'system_prompt': settings_raw.get('system_prompt', '''Вы - вежливый и профессиональный консультант компании. Отвечайте на вопросы клиентов, используя только информацию из базы знаний.
...
3. Пример хорошего форматирования услуг и цен:

📦 **Базовый тариф:**
• Стандартные услуги: 4 000 ₽
• Расширенные услуги: 5 600 ₽
• Полный пакет: 8 300 ₽

📦 **Премиум тариф:**
• Стандартные услуги: 4 500 ₽
• Расширенные услуги: 6 100 ₽
• Полный пакет: 8 800 ₽
