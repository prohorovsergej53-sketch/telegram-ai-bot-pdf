...
export const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Во всех тарифах доступны: web-чат на отдельной странице и виджет для встраивания на ваш сайт. На тарифе Бизнес добавляется Telegram. На тарифе Премиум — все мессенджеры (Telegram, VK, MAX). Один бот работает во всех каналах одновременно с единой базой знаний.'
    },
    {
