...
const COMMON_ICONS = [
  ...
  { name: 'Hotel', label: '🏨 Отель', category: 'hotel' },
  { name: 'Bed', label: '🛏️ Кровать', category: 'hotel' },
  { name: 'UtensilsCrossed', label: '🍴 Ресторан', category: 'hotel' },
  { name: 'Coffee', label: '☕ Кофе', category: 'hotel' },
  { name: 'Wifi', label: '📶 Wi-Fi', category: 'hotel' },
  { name: 'Car', label: '🚗 Машина', category: 'hotel' },
  { name: 'Dumbbell', label: '🏋️ Фитнес', category: 'hotel' },
  { name: 'Waves', label: '🌊 Бассейн', category: 'hotel' },
  { name: 'Plane', label: '✈️ Самолёт', category: 'hotel' },
  { name: 'Calendar', label: '📅 Календарь', category: 'hotel' },
  { name: 'Clock', label: '🕐 Часы', category: 'hotel' },
  { name: 'MapPin', label: '📍 Локация', category: 'hotel' },
  { name: 'Shield', label: '🛡️ Защита', category: 'hotel' },
  { name: 'CreditCard', label: '💳 Оплата', category: 'hotel' }
];
