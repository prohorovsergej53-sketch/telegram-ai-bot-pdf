...
export const HotelFooterSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Бот переведёт диалог на вашего администратора или предложит гостю оставить контакт для связи. Вы всегда можете дообучить бота на новых вопросах.'
    },
    {
      question: 'Как бот интегрируется с системой бронирования?',
      answer: 'Бот может работать автономно, информируя гостей и собирая заявки. Для глубокой интеграции с PMS свяжитесь с нами — обсудим ваш конкретный случай.'
    },
    {
