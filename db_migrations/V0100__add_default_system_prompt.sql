-- Добавляем дефолтный системный промпт в таблицу default_settings
...
{rag_context_placeholder}',
  'Дефолтный системный промпт для AI-ассистента. Используется если у тенанта не задан кастомный system_prompt.'
)
